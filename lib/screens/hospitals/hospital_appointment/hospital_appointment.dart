...
class HosptalAppointmentScreen extends StatefulWidget {
  final String name;

  const HosptalAppointmentScreen({
    Key key,
    @required this.name,
  }) : super(key: key);
  @override
  _HosptalAppointmentScreenState createState() =>
      _HosptalAppointmentScreenState();
}

class _HosptalAppointmentScreenState extends State<HosptalAppointmentScreen> {
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: RequiredValidator(
                    errorText: 'Problem Catagory is required'),
                decoration: InputDecoration(
                  hintText: 'eg , Head problem , Heart problem etc',
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(15.0),
                    borderSide: BorderSide(),
                  ),
...
Future<HospitalAppointmentEntity> createHospitalAppointment(
  String forHos,
  String fullName,
  String email,
  String contact,
  String problemCatagory,
  String problemDescription,
  String date,
) async {
  final http.Response response = await http.post(
    hospitalAppointmenrEndpoint,
